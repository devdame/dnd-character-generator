class Rogue < BaseClass
  FIRST_TIER_ABILITIES = [:dex, :int, :cha]
  ...
  MUST_HAVE_SKILLS = [:sleight_of_hand, :move_silently, :open_lock, :disable_device, :bluff]
  NICE_TO_HAVE_SKILLS = [:tumble, :diplomacy, :disguise, :escape_artist]
